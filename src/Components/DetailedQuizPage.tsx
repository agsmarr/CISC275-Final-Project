    ...
    <div>
      ...
      <Form>
        ...
        <Form.Group className="questions" controlId="q1">
          <Form.Label>1. Do you like to commute to work? If yes, how far?</Form.Label>
          <Form.Control
            type="text"
            value={textAnswer1}
        ...
        <Form.Group className="questions" controlId="q2">
          <Form.Label>2. What do you do in your leisure time?</Form.Label>
          <Form.Control
            type="text"
            value={textAnswer2}
        ...
        <Form.Group className="questions" controlId="q3">
          <Form.Label>3. What activities interests you? Why?</Form.Label>
          <Form.Control
           type="text"
           value={textAnswer3}
        ...
        <Form.Group className="questions" controlId="q4">
          <Form.Label>4. What are your favorite classes and why?</Form.Label>
          <Form.Control
           type="text"
          value={textAnswer4}
        ...
        <Form.Group className="questions" controlId="q5">
          <Form.Label>5. What are your soft and hard skills?</Form.Label>
          <Form.Control
          type="text"
          value={textAnswer5}
        ...
        <Form.Group className="questions" controlId="q6">
          <Form.Label>6. What are the three top characteristics you want to have in your work environment?</Form.Label>
          <Form.Control
            type="text"
            value={textAnswer6}
        ...
        <Form.Group className="questions" controlId="q7">
          <Form.Label>7. How important is job salary compared to job satisfaction when choosing a career?</Form.Label>
          <Form.Control
           type="text"
           value={textAnswer7}
        ...
        <Form.Group className="questions" controlId="q8">
         <Form.Label>8. Do you see yourself in a leadership role or would you rather specialize in a specific skill?</Form.Label>
          <Form.Control
            type="text"
            value={textAnswer8}
